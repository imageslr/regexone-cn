...
正如我们前面提到的，更准确总是好的，这适用于编码、对话、以及正则表达式。例如，你不会写一份购物清单让别人**买更多的 .\*** (Buy more .\*)，因为你不知道你能得到什么。相反，你可以写**买更多的牛奶** (Buy more milk) 或**买更多的面包** (Buy more bread)。在正则表达式中，我们可以明确地定义这些条件 (conditionals)。
